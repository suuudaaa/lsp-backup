        ...
        <el-row :gutter="12">
          <el-col :span="12" class="table-col">
            <div class="in-order-title-title1">
              <el-row>
                <el-col :span="18">
                  <span class="txt-weight">出库货物品牌</span>
                </el-col>
                <el-col :span="6">
                  <p class="recent-ser">
...
import { getOutBoundNumberInfo } from "@/api/getData";
...
export default {
  ...
  mounted() {
    ...
    this.getInOrderTotalData(this.params);
    ...
    this.$store.commit("updateOutOrderRequireParams", this.params);
