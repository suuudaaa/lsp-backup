  ...
  <div>
    <div class="tableContainer">
      <el-table
        ...
        stripe
      >
        <el-table-column prop="shipperName" label="客户公司名称" align="left"></el-table-column>
        <el-table-column prop="address" label="客户地址" align="left" :show-overflow-tooltip='true'></el-table-column>
...
import { companyCustomer } from "@/api/getData";
export default {
  components: {
    Pagination
  },
